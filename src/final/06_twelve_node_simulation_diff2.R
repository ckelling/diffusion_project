...
source("C:/Users/ckell/OneDrive/Penn State/Research/OverLeafCode_and_Images/Code/01_DIFF2.R")
...
dat_12_diff2 <- cbind(nodes, diam, cc, AverageTime, AverageNumInf)
colnames(dat_12_diff2)=c("Nodes","Diameter","CC","AvgT","AvgNum")
save(dat_12_diff2, file= "C:/Users/ckell/OneDrive/Penn State/Research/OverLeafCode_and_Images/Code/twelve_diff2.Rdata")
